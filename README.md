...
python guidpaint.py
    ...
    --use_skip_x0       Visualizing intermediate generation through skip sampling of x0 at multiple steps (default: use)
    --skip_stop_step    Set the timestep to stop visualization    
